...
//import com.example.foodsellingapp.repository.RefreshTokenRepository;
...
////        refreshToken.setUser(userRepository.findById(payloadDto.getUserId()).get());
////        refreshToken.setToken(tokenDto.getGeneratedToken());
